...
public class UpLoadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commenText=findViewById(R.id.comment);
        imageView=findViewById(R.id.post);
    }

    public void upLoad(View view){

        String comment = commenText.getText().toString();


        // image eklerken parse dosyasına dönüştürmemiz gerekiyor.

        //İmage ı byte cevirmemiz gerekiyor Parse File in icine koymak icin .
