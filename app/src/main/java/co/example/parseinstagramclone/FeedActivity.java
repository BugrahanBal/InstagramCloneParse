...
public class FeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.listView); // listviewin icerisinde olacak görüntüleri de ayrı xml de yaparız.
        ...
        //dataaları indirip bu yukarıdaki arraylere kaydetmek kaldı
    }

    public void download(){

        // burada da firebase de oldugu gibi Query kullanırız zaten cogu data cekmede böyle işlemler söz konusudur.
                            ...
                            parseFile.getDataInBackground(new GetDataCallback() {
                                ...
                                public void done(byte[] data, ParseException e) {
                                    if(e ==null && data!=null) {
                                        ...
                                        // byte dizisini decode edererk image e döndürecegiz.
                                        ...
                                        postClass.notifyDataSetChanged(); // adaptörü noptify etmek.
